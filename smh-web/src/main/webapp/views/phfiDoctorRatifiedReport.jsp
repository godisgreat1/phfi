					...
					<div class="main-content-holder">
						<div class="row">
							<div class="col-sm-12">
								...
								<form action="getDoctorReport" name="downloadReport" method="post">
									<input type="hidden" id="downloadPageNumberId" name="downLoadPageNumber" /> 
									<input type="hidden" id="downloadTypeId" name="downloadType" />
									<input type="hidden" id="downloadType" name="womanType" value="${womanType}" />
									...
									<c:when test="${!(fn:length(masterReportList) eq 0)}">
										<c:forEach items="${masterReportList}" var="womanData">
											<tr>	
												...
												<td data-title="Village Name"><div class="villageName">${womanData.villageName}</div></td>
											</tr>
										</c:forEach>
									</c:when>
									<c:otherwise>

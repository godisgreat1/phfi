 ...
 * @date Dec 23, 2015 10:52:03 PM
 * @version 1.0
 */
public class PhfiRegistrationRequest extends SearchRequest{

	/**
	 * 
	 */
	private static final long serialVersionUID = -975816852294669586L;
	...
	/**
	 * @param String the regDate to set
	 */
	...
	/**
	 * @param String the dateOfRecentDelivery to set
	 */
	public void setDateOfRecentDelivery(String String) {
		this.dateOfRecentDelivery = String;
	}
	/**
	...
	/**
	 * @param String the lmp to set
	 */
	public void setLmp(String String) {
		this.lmp = String;
	}
